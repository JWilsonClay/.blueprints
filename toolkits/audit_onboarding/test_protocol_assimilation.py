...
def test_protocol_assimilation():
    ...
    if exit_code == 1:
        ...
        print("    [Cycle 1] UPH Injection: Injecting `protocol_id`, `structure_status`, etc. -> SUCCESS")
        print("    [Cycle 2] Logical Re-sequencing: Anchoring 'Safety constraints' prior to 'Action'. -> SUCCESS")
        ...
        print("!!! TEST FAILED: The system allowed a drifting protocol to bypass the gate.")
        return False

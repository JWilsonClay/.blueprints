...
## Contents
<!-- BREADCRUMB -->
Reporting and compliance engine for the .blueprints substrate.
Enforces the Ventilated Prose standard and generates comprehensive gap analysis reports.
Manages the orchestration of unified substrate artifacts and documentation quality control.
<!-- BREADCRUMB_END -->
